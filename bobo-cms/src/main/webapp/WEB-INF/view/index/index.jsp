						...
						<div id="carousel" class="carousel slide" data-ride="carousel">
							...
							<div class="carousel-inner">
								...
								<div class="carousel-item">
									<img class="d-block w-100" src="/pic/a1.jpg" alt="Second slide">
								</div>
								<div class="carousel-item">
									<img class="d-block w-100" src="/pic/a2.jpg" alt="Third slide">
								</div>
								<div class="carousel-item">
									<img class="d-block w-100" src="/pic/a3.jpg" alt="Third slide">
								</div>
								<div class="carousel-item">
									<img class="d-block w-100" src="/pic/a4.jpg" alt="Third slide">
								</div>
								<div class="carousel-item">
									<img class="d-block w-100" src="/pic/a5.jpg" alt="Third slide">
								</div>
							</div>
