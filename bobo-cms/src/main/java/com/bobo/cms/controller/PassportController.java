...
import com.chenmengcheng.common.utils.CMSRuntimeException;
...
//	@RequestMapping( value="toReg",method=RequestMethod.GET)
	...
	@PostMapping("reg")
	public String reg(@Valid UserVO userVO, BindingResult result, Model model,RedirectAttributes redirectAttributes) throws CMSRuntimeException {
	 ...
	 */
	@PostMapping("login")
	public String login(User user,HttpSession session,Model model) throws CMSRuntimeException {
		try {
			//登录并返回用户对象
